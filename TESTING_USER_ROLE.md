...
| Langkah Pengujian | Skenario Uji           | Hasil yang Diharapkan                                                                                                                                                         | Status |
| :---------------- | :--------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----: |
| 3.1               | Ringkasan Poin & Level | Membuka halaman `/rewards` (setelah login). Menampilkan saldo poin total, peringkat Level ( Champion), dan bar kemajuan (progress bar) menuju level berikutnya secara akurat. |  [v]   |
...
| Langkah Pengujian | Skenario Uji            | Hasil yang Diharapkan                                                                                                                                                            | Status |
| :---------------- | :---------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----: |
| 5.1               | Evaluasi Menu Sidebar   | Cek sidebar Dashboard User. Hanya terdapat 3 menu utama: **Dashboard**, **Upload Aktivitas**, dan **Profil**. (Tidak ada menu Challenge, Marketplace, Reward, atau Riwayat).     |  [v]   |
...
catatan: belum lihat fitur voucher

### 4. Riwayat Aktivitas Lingkungan (`/riwayat`)

4.1 | Detail Log Aktivitas : belum ada image preview
