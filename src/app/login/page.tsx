...
export default function LoginPage() {
  return (
    <main className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-brand-forest text-white p-12 flex-col justify-between overflow-hidden">
        <div className="relative z-10">
          ...
          <h1 className="font-display text-5xl font-bold leading-tight w-full">
            Senang Melihatmu Lagi, Lanjutkan Aksimu!
          </h1>
        </div>
      ...
      {/* Right Column - Form */}
      <div className="flex-1 flex flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24 relative">
        {/* Mobile Back Button */}
        ...
        <div className="mx-auto w-full max-w-sm">
          <div className="mb-6 mt-12 lg:mt-0 flex flex-col items-center text-center">
            ...
            <h2 className="font-display text-2xl font-bold text-ink-900">Masuk ke Akun Anda</h2>
            <p className="text-sm text-ink-400 mt-1.5">Selamat datang kembali! Silakan masukkan detail Anda.</p>
          </div>
          <Suspense fallback={
            <div className="flex flex-col items-center gap-3 py-10">
              <div className="h-8 w-8 animate-spin rounded-full border-4 border-brand-line border-t-brand-forest"></div>
            </div>
          }>
            <LoginForm />
          </Suspense>
