...
export default function LeaderboardPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-paper-3 flex flex-col pt-[80px]">
      <main className="flex-1 py-[56px] md:py-[88px] font-sans text-brand-text">
        <div className="max-w-[1180px] mx-auto px-8 md:px-10">
          ...
          <div className="mb-8">
            <Link 
              href="/" 
              className="inline-flex items-center gap-2 text-xs font-bold text-brand-forest hover:text-brand-forest-2 transition"
            >
          ...
          <div className="text-center max-w-xl mx-auto mb-16 space-y-2">
            ...
            <h1 className="font-display text-4xl font-semibold text-brand-text leading-tight">
              Pahlawan Hijau Ecolution
            </h1>
            <p className="font-body text-[15px] text-brand-text-soft">
              Apresiasi bagi pejuang dengan kontribusi aksi hijau dan perolehan poin tertinggi secara live dari database.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              {/* User Rank Status */}
              {user && userRank !== null && (
                <div className="rounded-xl border border-brand-line bg-brand-paper-2 p-5 flex flex-col sm:flex-row justify-between items-center gap-4 mb-8 max-w-2xl mx-auto animate-fade-in">
