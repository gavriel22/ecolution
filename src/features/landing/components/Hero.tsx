        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end mt-16 pb-12 gap-8">
          ...
          <div className="flex flex-col items-end gap-6 max-w-xs text-white drop-shadow-md">
            ...
            <div className="flex gap-4">
              <Link href="/marketplace" className="px-8 py-3 bg-[#fbbc04] hover:bg-[#e3aa04] text-gray-900 rounded-full font-medium transition-colors text-lg">
                Shop now
              </Link>
              <Link href="/about" className="px-8 py-3 bg-transparent border border-white hover:bg-white/10 text-white rounded-full font-medium transition-colors text-lg">
                Learn more
              </Link>
            </div>
          </div>
